...
icon = pygame.image.load(
    r'/Users/humzaiqbal/Downloads/globe.png')
pygame.display.set_icon(icon)

logo = pygame.image.load(
    r'/Users/humzaiqbal/Downloads/logo.png')
logo = pygame.transform.scale(logo, (140, 120))

b2 = pygame.image.load(
    r'/Users/humzaiqbal/Downloads/b2.png')
b2 = pygame.transform.scale(b2, (760, 600))

plane_art = pygame.image.load(r'/Users/humzaiqbal/Downloads/plane.png')
...
while runner:
    ...
    # Player
    playerImg = pygame.image.load(r'/Users/humzaiqbal/Downloads/globe.png')
    playerX = 370
    playerY = 480
    playerX_change = 0
    playerY_change = 0
